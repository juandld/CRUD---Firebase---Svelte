    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const updateTask = async () => {
    		try {
    			...
    			Toastify({ text: "Task updated" }).showToast();
    		} catch(error) {
    			console.error(error);
    		}
    	};
